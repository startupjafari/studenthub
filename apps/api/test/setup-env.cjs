...
// Служебный Telegram-бот в тестах выключен принудительно: .env разработчика может
// содержать боевой токен, и e2e начали бы слать сообщения в рабочий чат команды.
