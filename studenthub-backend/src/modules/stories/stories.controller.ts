...
export class StoriesController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new 24-hour story. Story automatically expires after 24 hours. Media must be IMAGE or VIDEO type.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns active stories from user and their friends, grouped by author. Only shows stories that have not expired.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Views a story and creates a view record. Sends notification to story author if not own story.',
  })
